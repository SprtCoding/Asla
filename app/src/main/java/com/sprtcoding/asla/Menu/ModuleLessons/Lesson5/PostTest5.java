...
public class PostTest5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_post_test5);
        init();

        // Retrieve the score from SharedPreferences
        SharedPreferences sharedPreferences = getSharedPreferences("PreTestPrefs5", MODE_PRIVATE);
        lesson1_preTest_score = sharedPreferences.getInt("pre_test_score5", 0);
        ...
        Lesson5QuizDbHelper quizDbHelper = new Lesson5QuizDbHelper(this);
    ...
    private void showAnalyzeDialog() {
        ...
        // Retrieve the score from SharedPreferences
        SharedPreferences sharedPreferences = getSharedPreferences("PostTestPrefs5", MODE_PRIVATE);
        int postScore = sharedPreferences.getInt("post_test_score5", 0);
    ...
    private void saveScoreToSharedPreferences(int score) {
        ...
        editor.putInt("post_test_score5", score);
        editor.apply();
    }
