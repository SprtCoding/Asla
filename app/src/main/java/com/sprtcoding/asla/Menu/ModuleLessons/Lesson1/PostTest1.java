...
public class PostTest1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_post_test1);
        init();
        ...
        lesson1_preTest_score = sharedPreferences.getInt("pre_test_score", 0);
    ...
    private void showCompleteDialog() {
        View testCompleteDialog = LayoutInflater.from(PostTest1.this).inflate(R.layout.prepost_test_complete_dialog, null);
        AlertDialog.Builder testCompleteDialogBuilder = new AlertDialog.Builder(PostTest1.this);
    ...
    private void showAnalyzeDialog() {
        View analyzeDialog = LayoutInflater.from(PostTest1.this).inflate(R.layout.analyze_dialog, null);
        AlertDialog.Builder analyzeDialogBuilder = new AlertDialog.Builder(PostTest1.this);

        analyzeDialogBuilder.setView(analyzeDialog);

        // Retrieve the score from SharedPreferences
        SharedPreferences sharedPreferences = getSharedPreferences("PostTestPrefs", MODE_PRIVATE);
        int postScore = sharedPreferences.getInt("post_test_score", 0);
    ...
    private void saveScoreToSharedPreferences(int score) {
        ...
        editor.putInt("post_test_score", score);
        editor.apply();
    }
