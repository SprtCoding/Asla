...
import com.sprtcoding.asla.Menu.ModuleLessons.Lesson2.Lesson_2;
...
public class PreTest3 extends AppCompatActivity {
    ...
    private void showCompleteDialog() {
        ...
        _done_btn.setOnClickListener(view -> {
            ...
            Intent i = new Intent(this, Lesson_3.class);
            startActivity(i);
            finish();
        });
    ...
    private void saveScoreToSharedPreferences(int score) {
        ...
        editor.putInt("pre_test_score3", score);
        editor.apply();
    }
