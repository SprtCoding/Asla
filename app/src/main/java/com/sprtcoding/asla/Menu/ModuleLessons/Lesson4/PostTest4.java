package com.sprtcoding.asla.Menu.ModuleLessons.Lesson4;
...
import com.sprtcoding.asla.Menu.ModuleLessons.Lesson3.QDB3.Lesson3QuizDbHelper;
import com.sprtcoding.asla.Menu.ModuleLessons.Lesson4.QDB4.Lesson4QuizDbHelper;
...
public class PostTest4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_post_test4);
        init();
        ...
        SharedPreferences sharedPreferences = getSharedPreferences("PreTestPrefs4", MODE_PRIVATE);
        lesson1_preTest_score = sharedPreferences.getInt("pre_test_score4", 0);
        ...
        Lesson4QuizDbHelper quizDbHelper = new Lesson4QuizDbHelper(this);
    ...
    private void showAnalyzeDialog() {
        ...
        // Retrieve the score from SharedPreferences
        SharedPreferences sharedPreferences = getSharedPreferences("PostTestPrefs4", MODE_PRIVATE);
        int postScore = sharedPreferences.getInt("post_test_score4", 0);
    ...
    private void saveScoreToSharedPreferences(int score) {
        ...
        editor.putInt("post_test_score4", score);
        editor.apply();
    }
