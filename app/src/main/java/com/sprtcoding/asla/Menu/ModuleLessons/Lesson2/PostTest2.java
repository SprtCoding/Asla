...
import com.sprtcoding.asla.Menu.ModuleLessons.Lesson1.PostTest1;
...
public class PostTest2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lesson1_preTest_score = sharedPreferences.getInt("pre_test_score2", 0);
        ...
        Lesson2QuizDbHelper quizDbHelper = new Lesson2QuizDbHelper(this);
    ...
    private void showAnalyzeDialog() {
        ...
        // Retrieve the score from SharedPreferences
        SharedPreferences sharedPreferences = getSharedPreferences("PostTestPrefs2", MODE_PRIVATE);
        int postScore = sharedPreferences.getInt("post_test_score2", 0);
    ...
    private void saveScoreToSharedPreferences(int score) {
        ...
        editor.putInt("post_test_score2", score);
        editor.apply();
    }
