...
import com.sprtcoding.asla.Menu.ModuleLessons.Lesson5.Lesson_5;
...
public class PreTest6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pre_test6);
        init();
    ...
    private void showCompleteDialog() {
        ...
        _done_btn.setOnClickListener(view -> {
            ...
            Intent i = new Intent(this, Lesson_6.class);
            startActivity(i);
            finish();
        });
    ...
    private void saveScoreToSharedPreferences(int score) {
        ...
        editor.putInt("pre_test_score6", score);
        editor.apply();
    }
