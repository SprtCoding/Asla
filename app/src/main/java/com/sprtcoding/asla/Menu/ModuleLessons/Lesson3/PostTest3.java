...
import com.sprtcoding.asla.Menu.ModuleLessons.Lesson2.QDB2.Lesson2QuizDbHelper;
...
public class PostTest3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_post_test3);
        init();
        ...
        SharedPreferences sharedPreferences = getSharedPreferences("PreTestPrefs3", MODE_PRIVATE);
        lesson1_preTest_score = sharedPreferences.getInt("pre_test_score3", 0);
        ...
        Lesson3QuizDbHelper quizDbHelper = new Lesson3QuizDbHelper(this);
    ...
    private void showAnalyzeDialog() {
        ...
        // Retrieve the score from SharedPreferences
        SharedPreferences sharedPreferences = getSharedPreferences("PostTestPrefs3", MODE_PRIVATE);
        int postScore = sharedPreferences.getInt("post_test_score3", 0);
    ...
    private void saveScoreToSharedPreferences(int score) {
        ...
        editor.putInt("post_test_score3", score);
        editor.apply();
    }
