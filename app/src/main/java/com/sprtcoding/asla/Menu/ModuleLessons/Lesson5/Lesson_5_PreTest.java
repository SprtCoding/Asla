...
import com.sprtcoding.asla.Menu.ModuleLessons.Lesson4.PreTest4;
import com.sprtcoding.asla.R;

public class Lesson_5_PreTest extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lesson5_pre_test);
        _init();
    ...
    private void _setClickListener() {
        start_pre_test_btn.setOnClickListener(view -> {
            Intent i = new Intent(this, PreTest5.class);
            startActivity(i);
        });
