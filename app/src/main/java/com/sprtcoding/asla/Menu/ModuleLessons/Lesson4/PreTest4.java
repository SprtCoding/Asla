...
import com.sprtcoding.asla.Menu.ModuleLessons.Lesson3.Lesson_3;
...
public class PreTest4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pre_test4);
        init();
    ...
    private void showCompleteDialog() {
        ...
        _done_btn.setOnClickListener(view -> {
            ...
            Intent i = new Intent(this, Lesson_4.class);
            startActivity(i);
            finish();
        });
    ...
    private void saveScoreToSharedPreferences(int score) {
        ...
        editor.putInt("pre_test_score4", score);
        editor.apply();
    }
