...
import com.sprtcoding.asla.Menu.EasyCategory.QuestionDB.QuizDbHelper;
...
public class ReviewMePlay extends AppCompatActivity {
    ...
    private void showCompleteDialog() {
        View testCompleteDialog = LayoutInflater.from(ReviewMePlay.this).inflate(R.layout.test_complete_dialog, null);
        AlertDialog.Builder testCompleteDialogBuilder = new AlertDialog.Builder(ReviewMePlay.this);
        ...
        TextView header = testCompleteDialog.findViewById(R.id.header);
        ...
        if(score <= 7) {
            ...
            score_text.setText("Please try again!");
            anim.setAnimation(R.raw.sad);
        }else {
            happySound.playSound();
            header.setText("You Passed");
            score_text.setText("Congratulations!");
