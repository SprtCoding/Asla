...
public class GuessMe extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //how to play dialog
        View how_to_PlayDialog = LayoutInflater.from(GuessMe.this).inflate(R.layout.how_to_play_dialog, null);
        AlertDialog.Builder how_to_PlayDialogBuilder = new AlertDialog.Builder(GuessMe.this);
        ...
        _how_to_play_info.setText("Guess what will be the output based on the given code. Tap the picture to select your answer.");
        ...
        _btn_play.setOnClickListener(view -> {
            ...
            Runnable runnable = () -> {
                ...
                Intent i = new Intent(this, GuessMePlay.class);
                startActivity(i);
            };
