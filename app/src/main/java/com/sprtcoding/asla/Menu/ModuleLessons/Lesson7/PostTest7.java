package com.sprtcoding.asla.Menu.ModuleLessons.Lesson7;
...
import com.sprtcoding.asla.Menu.ModuleLessons.Lesson7.QDB7.Lesson7QuizDbHelper;
...
public class PostTest7 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_post_test7);
        init();

        // Retrieve the score from SharedPreferences
        SharedPreferences sharedPreferences = getSharedPreferences("PreTestPrefs7", MODE_PRIVATE);
        lesson1_preTest_score = sharedPreferences.getInt("pre_test_score7", 0);
        ...
        Lesson7QuizDbHelper quizDbHelper = new Lesson7QuizDbHelper(this);
    ...
    private void showAnalyzeDialog() {
        ...
        // Retrieve the score from SharedPreferences
        SharedPreferences sharedPreferences = getSharedPreferences("PostTestPrefs7", MODE_PRIVATE);
        int postScore = sharedPreferences.getInt("post_test_score7", 0);
    ...
    private void saveScoreToSharedPreferences(int score) {
        ...
        editor.putInt("post_test_score7", score);
        editor.apply();
    }
