...
import com.sprtcoding.asla.Menu.ModuleLessons.Lesson4.Lesson_4;
...
public class PreTest5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pre_test5);
        init();
    ...
    private void showCompleteDialog() {
        ...
        _done_btn.setOnClickListener(view -> {
            ...
            Intent i = new Intent(this, Lesson_5.class);
            startActivity(i);
            finish();
        });
    ...
    private void saveScoreToSharedPreferences(int score) {
        ...
        editor.putInt("pre_test_score5", score);
        editor.apply();
    }
