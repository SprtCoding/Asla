...
import com.sprtcoding.asla.Menu.ModuleLessons.Lesson1.Lesson_1;
import com.sprtcoding.asla.Menu.ModuleLessons.Lesson1.PreTest1;
...
public class PreTest2 extends AppCompatActivity {
    ...
    private void showCompleteDialog() {
        ...
        _done_btn.setOnClickListener(view -> {
            ...
            Intent i = new Intent(this, Lesson_2.class);
            startActivity(i);
            finish();
        });
    ...
    private void saveScoreToSharedPreferences(int score) {
        ...
        editor.putInt("pre_test_score2", score);
        editor.apply();
    }
