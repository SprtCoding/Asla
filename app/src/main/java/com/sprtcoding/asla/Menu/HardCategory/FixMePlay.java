...
public class FixMePlay extends AppCompatActivity {
    ...
    int score = 0, current_item_no = 1, total_item_no = 10;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fix_me_play);
        _init();
        setAnswer();
    ...
    private void setAnswer() {
        answer_1 = "content";
        answer_2 = "setMessage";
        answer_3 = "OnClickListener";
        answer_4 = "public void";
        answer_5 = "AlertDialog";
...
//                         .start();
    ...
    private void showCorrectDialog() {
        View correctDialog = LayoutInflater.from(FixMePlay.this).inflate(R.layout.correct_dialog, null);
        AlertDialog.Builder correctDialogBuilder = new AlertDialog.Builder(FixMePlay.this);
        ...
        output.setImageResource(R.drawable.alert_dialog);

        labelTxt.setText("Congrats you debug the Alert Dialog!");
    ...
    private void showWrongDialog() {
        View wrongDialog = LayoutInflater.from(FixMePlay.this).inflate(R.layout.wrong_dialog, null);
        AlertDialog.Builder wrongDialogBuilder = new AlertDialog.Builder(FixMePlay.this);
